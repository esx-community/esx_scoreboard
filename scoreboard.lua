...
Faketimer = 0
    ...
    while true do
        ...
        if IsControlPressed(0, 11)--[[ INPUT_PHONE ]] then
            ...
            if not listOn then
                ...
                if Faketimer >= 2 then
                ESX.TriggerServerCallback('stadusrp_getJobsOnline', function(ems, police, taxi, mek, bil, bennys, ica, spelare)
 myVar2 = ems
 myVar3 = police
 myVar4 = taxi
 myVar5 = mek
  ...
  spelare = myVar9})
    ...
    Faketimer = 0
            ...
            Faketimer = 0
                ...
                while listOn do
                    Wait(0)
                    if(IsControlPressed(0, 11) == false) then
                        listOn = false
                        SendNUIMessage({
                            meta = 'close'
                        })
